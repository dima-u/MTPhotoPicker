...
@implementation MTCheckmarkView
...
- (void)drawRect:(CGRect)rect
{
    ...
    CGRect borderRect = CGRectInset(self.bounds,  self.checkmarkLineWidth / 2, self.checkmarkLineWidth / 2);
    
    
    UIBezierPath * border = [UIBezierPath bezierPathWithOvalInRect:borderRect];
    border.lineWidth = self.checkmarkLineWidth;
    [border stroke];
